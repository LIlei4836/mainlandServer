    ...
    while 1:
        try:
            ...
            urlDict = ["http://tvc4.forexpros.com/2b3e7c8c1966d9488b9b637c11017675/", str(time_stamp),
                       "/6/6/28/history?symbol=", str(symbol),
                       "&resolution=", str(resolution), "&from=", str(time_stamp - time_len), "&to=", str(time_stamp)]
            url = ''.join(urlDict)
            # print(url)
...
if __name__ == '__main__':
    ...
    A = {'1':'eurusdt','8832':'kcusdt','8862':'trqusdt','940801':'csi300-chartusdt','58':'nzdjpy'}
    p = Pool(len(A))
    for symbol in A:
